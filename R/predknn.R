...
knnPred <- predictPattern(zaKeep, zdKeep, "pattern6", df, kc, useClk = TRUE)
...
knnPred <- predictPattern(zaKeep, zdKeep, "pattern7", df, kc, useClk = TRUE)
...
knnPred <- predictPattern(zaKeep, zdKeep, "pattern8", df, kc, useClk = TRUE)
